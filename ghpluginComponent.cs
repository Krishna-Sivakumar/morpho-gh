...
namespace ghplugin
{
  public class ghpluginComponent : GH_Component
  {
    /// <summary>
    ...
    /// </summary>
    public ghpluginComponent()
      : base("ghplugin Component", "Nickname",
    ...
    /// </summary>
    public override Guid ComponentGuid => new Guid("622a8dbe-c244-4883-8fbb-a816cf706d3e");
  }

  public class Squarer: GH_Component
  {
    /// <summary>
    /// Each implementation of GH_Component must provide a public 
    /// constructor without any arguments.
    ...
    public Squarer()
      : base("Squarer", "Sqr",
        "Squares an input integer.",
        "Morpho", "Gene Generator")
    {
    }
    ...
    protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
    {
      ...
      // All parameters must have the correct access type. If you want 
      // to import lists or trees of values, modify the ParamAccess flag.
      pManager.AddNumberParameter("Input", "i", "Squaring Input", GH_ParamAccess.item);
    ...
    protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
    {
      // Use the pManager object to register your output parameters.
      // Output parameters do not have default values, but they too must have the correct access type.
      pManager.AddNumberParameter("Result", "r", "Squared Result", GH_ParamAccess.item);
    ...
    /// that use the old ID will partially fail during loading.
    /// </summary>
    public override Guid ComponentGuid => new Guid("622a8dbe-c244-4883-8fbb-a816cf706d3f");
  }
}